...
tags: [area/desarrollo, comp/agente, stack/claude, comp/rag, estado/pendiente]
---
...
- [ ] **T03.3.1** — Orquestador que maneja el turno: recibe mensaje, llama a Claude con historial + tools, ejecuta tool si aplica, devuelve respuesta.
...
- [ ] **T03.4.1** — Extraer/actualizar el `perfil` del lead tras cada turno.
...
- [ ] **T03.4.2** — Calcular el score y la temperatura.
...
- [ ] **T03.5.1** — Marcar leads tibios/fríos para seguimiento y dejar el gancho de reactivación.
